...
<body>
    ...
    <div class="fan-container">
        <div class="fan">
            <a href="ceiling">
                <img src="ceiling.jpg" alt="Ceiling Fan">
            </a>
            <h3>Ceiling Fan</h3>
             </div>
        ...
        <div class="fan">
            <a href="table">
                <img src="table.jpg" alt="Table Fan">
            </a>
            <h3>Table Fan</h3>
           </div>
        ...
        <div class="fan">
            <a href="exhaust">
                <img src="exhaust.jpg" alt="Exhaust Fan">
            </a>
            <h3>Exhaust Fan</h3>
            </div>
    ...
    <div class="fan">
            <a href="pedestal">
                <img src="Pedestal.jpg" alt="Pedestal Fan">
            </a>
            <h3>Pedestal Fan</h3>
            </div>
     </div>
    ...
    <div class="fan">
            <a href="tower">
                <img src="tower.jpg" alt="Tower Fan">
            </a>
            <h3>Tower Fan</h3>
            </div>
    
    <div class="fan">
            <a href="exhaust_fan_page.html">
                <img src="wall-mounted.jpg" alt="wall-mounted Fan">
            </a>
    ...
    <div class="fan">
            <a href="exhaust_fan_page.html">
                <img src="floor.jpg" alt="Floor Fan">
            </a>
            <h3>Floor Fan</h3>
            </div>
    </div>
